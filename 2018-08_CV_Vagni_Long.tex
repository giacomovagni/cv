...
\begin{cv}{Curriculum Vitae}
 ...
 \newpage
   ...
   \begin{cvlist}{Publications}
		 ...
		 \item [2018] \textbf{Vagni, G.} \& Cornwell, B. (2018). ``Patterns of everyday activities across social contexts.'' \emph{Proceedings of the National Academy of Sciences.} \href{https://doi.org/10.1073/pnas.1718020115}{doi: 10.1073/pnas.1718020115} 
		 
		 \item \textbf{Vagni, G.}  (Accepted with minor corrections) ``Alone Together: Gender Inequalities in Couple Time''. \emph{Social Indicators Research}. 
		  	
		  	\item [] \textbf{Vagni, G.}  (Forthcoming). ``Family Time at the turn of the 21st century.'' In J. Gershuny and O. Sullivan (Eds.) \emph{The Great Day} (pp. 220-265). London:Penguin Books.  
 ...
 \begin{cvlist}{Working Papers}
 	...
 	\item Vagni, G., and Sullivan, O. ``Couple Work-schedules and the Division of Labor.''
 	\item Vagni, G., and Taiji, R.  ``Sunday Work and Couple time.''
...
\begin{cvlist}{Communications}
		...
		\item[2018] ``Alone Together''. \emph{PopFest 2017}, 20th of June. Nuffield College, University of Oxford, UK. 
