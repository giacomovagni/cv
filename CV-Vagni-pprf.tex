...
\begin{cv}{Curriculum Vitae}
 ...
 \newpage
  ...
  \begin{cvlist}{Under Review}
  	...
  	\item \textbf{Vagni, G.} ``All You Need is Love. Searching for Causal Effects of Spouse on Enjoyment.'' 	
  	\item \textbf{Vagni, G.} ``From Constraints to Culture. The Social Stratification of Parental Time.'' 
  	\item \textbf{Vagni, G.} and Widmer, E. ``Couple Time and Partnership Quality: an Empirical Assessment using Diary Data."
  \end{cvlist}
  
  \begin{cvlist}{Working Papers}
  	
  	\item 1. ``The Motherhood Earnings Penalty: A New Approach and New
  	Estimates for the UK.'' (with Richard Breen)
  	\item 2. ``Schedules, Resources, and the Division of Household Labour'' (with Oriel Sullivan)
  	\item 3. ``Bring It All Back Home. Decomposing the Stratification of Childcare Over Time.'' (single author)
  	\item 4. ``The Social Stratification of Time Use Patterns.'' (single author)
...
\begin{cvlist}{Communications}
    ...
    \item[2019]  ``The Motherhood Earnings Penalty: A New Approach and New
    Estimates for the UK.''. \emph{ECSR 2019}, 13 September 2019. University of Lausanne, CH. 
            
    \item[]  ``Sliding Doors. The Causal Effect of Children on Partners' Earnings''. \emph{PopFest 2019}, 28 May 2019. London School of Economics, UK. 
